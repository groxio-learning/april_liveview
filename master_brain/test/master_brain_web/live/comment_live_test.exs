defmodule MasterBrainWeb.CommentLiveTest do
  use MasterBrainWeb.ConnCase

  import Phoenix.LiveViewTest

  alias MasterBrain.Timeline

  @create_attrs %{body: "some body", reaction: "some reaction", username: "some username"}
  ...
  defp fixture(:comment) do
    {:ok, comment} = Timeline.create_comment(@create_attrs)
    comment
  end
